...
def test_st(rtol,
    ...
    np.testing.assert_allclose(sol.Y[-1],
                               np.array([1.035543e+00, 7.647195e-02, 9.804917e-01, -2.006169e-01,
                                         1.611352e-01, 1.000000e+00, 1.000000e+00, 1.000000e+00,
                                         7.000000e-01, 5.027251e+01, -9.999989e+04, -5.027251e+01,
                                         8.500000e+01]),
                               rtol=rtol,
                               atol=atol)
