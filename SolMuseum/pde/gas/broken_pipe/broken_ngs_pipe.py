...
def rupture_pipe(p: Var,
    ...
    match method:
        case 'euler':
            artifact = rupture_ngs_pipe_Euler(p,
                                              q,
                                              lam,
                                              va,
                                              D,
        ...
        case 'cdm':
            artifact = rupture_ngs_pipe_cdm(p,
                                            q,
                                            lam,
                                            va,
                                            D,
        ...
        case 'cha':
            artifact = rupture_ngs_pipe_cha(p,
                                            q,
                                            lam,
                                            va,
                                            D,
                                            ...
                                            idx_leak)
        case 'kt1':
            artifact = rupture_ngs_pipe_kt1(p,
                                            q,
                                            lam,
                                            va,
                                            D,
        ...
        case 'kt2':
            artifact = rupture_ngs_pipe_kt2(p,
                                            q,
                                            lam,
                                            va,
                                            D,
                                            ...
                                            idx_leak)
        case 'weno3':
            artifact = rupture_ngs_pipe_weno3(p,
                                              q,
                                              lam,
                                              va,
                                              D,
